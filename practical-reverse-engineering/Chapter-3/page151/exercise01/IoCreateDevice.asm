...
fffff800`1205d01d 48894008        mov     qword ptr [rax+8],rax		; InitializeListHead
fffff800`1205d021 488900          mov     qword ptr [rax],rax		; InitializeListHead
fffff800`1205d024 488d4160        lea     rax,[rcx+60h]
fffff800`1205d028 48894008        mov     qword ptr [rax+8],rax		; InitializeListHead
fffff800`1205d02c 488900          mov     qword ptr [rax],rax		; InitializeListHead
...
fffff800`1205d209 48894008        mov     qword ptr [rax+8],rax		; InitializeListHead
fffff800`1205d20d 488900          mov     qword ptr [rax],rax		; InitializeListHead
