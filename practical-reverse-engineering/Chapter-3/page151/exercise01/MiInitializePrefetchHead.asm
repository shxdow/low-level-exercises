...
fffff800`11db2bc8 48894008        mov     qword ptr [rax+8],rax		; InitializeListHead
fffff800`11db2bcc 488900          mov     qword ptr [rax],rax		; InitializeListHead
fffff800`11db2bcf 488d4118        lea     rax,[rcx+18h]
fffff800`11db2bd3 48894008        mov     qword ptr [rax+8],rax		; InitializeListHead
fffff800`11db2bd7 488900          mov     qword ptr [rax],rax		; InitializeListHead
fffff800`11db2bda 488d4128        lea     rax,[rcx+28h]
fffff800`11db2bde 48894008        mov     qword ptr [rax+8],ra		; InitializeListHeadx
fffff800`11db2be2 488900          mov     qword ptr [rax],rax		; InitializeListHead
