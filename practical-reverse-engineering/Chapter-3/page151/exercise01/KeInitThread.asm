...
fffff800`11fd735f 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`11fd7363 488900          mov     qword ptr [rax],rax			; InitializeListHead
fffff800`11fd7366 488d8108030000  lea     rax,[rcx+308h]
fffff800`11fd736d 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`11fd7371 488900          mov     qword ptr [rax],rax			; InitializeListHead
...
fffff800`11fd73d9 48894908        mov     qword ptr [rcx+8],rcx			; InitializeListHead
fffff800`11fd73dd 488909          mov     qword ptr [rcx],rcx			; InitializeListHead
fffff800`11fd73e0 488d87a8000000  lea     rax,[rdi+0A8h]
fffff800`11fd73e7 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`11fd73eb 488900          mov     qword ptr [rax],rax			; InitializeListHead
