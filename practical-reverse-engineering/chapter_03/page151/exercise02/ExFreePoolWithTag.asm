...
fffff803`d9af7ed9 488b4208        mov     rax,qword ptr [rdx+8]							; rax->Flink = rdx->Blink
fffff803`d9af7edd 488911          mov     qword ptr [rcx],rdx							; rcx->Flink = rdx
fffff803`d9af7ee0 48894108        mov     qword ptr [rcx+8],rax							; rcx->Blink = rax
...
fffff803`d9af7ef1 488908          mov     qword ptr [rax],rcx							; rax->Flink = rcx
fffff803`d9af7ef4 48894a08        mov     qword ptr [rdx+8],rcx							; rdx->Blink = rcx
...
fffff803`d9af8115 488b01          mov     rax,qword ptr [rcx]								; rax->Flink = rcx
fffff803`d9af8118 48894b08        mov     qword ptr [rbx+8],rcx								; rbx->Blink = rcx
fffff803`d9af811c 488903          mov     qword ptr [rbx],rax								; rbx->Flink = rax
...
fffff803`d9af8125 48895808        mov     qword ptr [rax+8],rbx								; rax->Blink = rbx
fffff803`d9af8129 488919          mov     qword ptr [rcx],rbx								; rcx->Flink = rbx
