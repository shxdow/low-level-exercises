...
fffff803`d99593be 4c8901          mov     qword ptr [rcx],r8			; rcx->Flink = r8
fffff803`d99593c1 48894108        mov     qword ptr [rcx+8],rax			; rcx->Blink = rax
...
fffff803`d99593cf 49894808        mov     qword ptr [r8+8],rcx			; r8->Blink = rcx
fffff803`d99593d3 488908          mov     qword ptr [rax],rcx			; rax->Flink = rcx
...
fffff803`d995953c 488b4108        mov     rax,qword ptr [rcx+8]				; rax->Flink = rcx->Blink
fffff803`d9959540 498908          mov     qword ptr [r8],rcx				; r8->Flink = rcx
fffff803`d9959543 49894008        mov     qword ptr [r8+8],rax				; r8->Blink = rax
...
fffff803`d9959550 4c8900          mov     qword ptr [rax],r8				; rax->Flink = r8
fffff803`d9959553 4c894108        mov     qword ptr [rcx+8],r8				; rcx->Blink = r8
...
fffff803`d99595f0 488b01          mov     rax,qword ptr [rcx]					; rax->Flink = rcx
fffff803`d99595f3 49894808        mov     qword ptr [r8+8],rcx					; r8->Blink = rcx
fffff803`d99595f7 498900          mov     qword ptr [r8],rax					; r8->Flink = rax
...
fffff803`d9959604 4c894008        mov     qword ptr [rax+8],r8					; rax->Blink = r8
fffff803`d9959608 4c8901          mov     qword ptr [rcx],r8					; rcx->Flink = r8
