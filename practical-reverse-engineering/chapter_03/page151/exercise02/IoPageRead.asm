...
nt!IoPageRead+0x1a0:
fffff803`d995d410 498b07          mov     rax,qword ptr [r15]									; rax->Flink = r15
fffff803`d995d413 4d897e08        mov     qword ptr [r14+8],r15									; r14->Blink = r15 
fffff803`d995d417 498906          mov     qword ptr [r14],rax									; r14->Flink = rax
...
nt!IoPageRead+0x1b4:
fffff803`d995d424 4c897008        mov     qword ptr [rax+8],r14									; rax->Blink = r14
fffff803`d995d428 4d8937          mov     qword ptr [r15],r14									; r15->Flink = r14
