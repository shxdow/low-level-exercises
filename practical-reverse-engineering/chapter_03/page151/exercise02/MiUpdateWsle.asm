...
fffff803`d991a0bf 488907          mov     qword ptr [rdi],rax												; rdi->Flink = rax
fffff803`d991a0c2 48894f08        mov     qword ptr [rdi+8],rcx												; rdi->Blink = rcx
...
fffff803`d991a0d0 48897808        mov     qword ptr [rax+8],rdi												; rax->Blink = rdi
fffff803`d991a0d4 48893d85882300  mov     qword ptr [nt!MmWorkingSetExpansionHead (fffff803`d9b52960)],rdi	; rcx->Flink = rdi
