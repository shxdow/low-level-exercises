...
fffff800`12372a8c 488b4808        mov     rcx,qword ptr [rax+8]						; rcx->Flink = rax->Blink
fffff800`12372a90 488902          mov     qword ptr [rdx],rax						; rdx->Flink = rax
fffff800`12372a93 48894a08        mov     qword ptr [rdx+8],rcx						; rdx->Blink = rcx
...
fffff800`12372a9c 488911          mov     qword ptr [rcx],rdx						; rcx->Flink = rdx
fffff800`12372a9f 48895008        mov     qword ptr [rax+8],rdx						; rax->Blink = rdx
...
fffff800`12372d01 4d8b1c24        mov     r11,qword ptr [r12]									; r11->Flink = r12
fffff800`12372d05 4c896308        mov     qword ptr [rbx+8],r12									; rbx->Blink = r12
fffff800`12372d09 4c891b          mov     qword ptr [rbx],r11									; rbx->Flink = r11
...
fffff800`12372d16 49895b08        mov     qword ptr [r11+8],rbx									; r11->Blink = rbx
...
fffff800`12372d27 49891c24        mov     qword ptr [r12],rbx									; r12->Flink = rbx
