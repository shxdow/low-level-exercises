...
fffff800`11c7f6d4 488d1525142e00  lea     rdx,[nt!CcVacbFreeList (fffff800`11f60b00)]			; rdx->Flink = nt!CcVacbFreeList 
fffff800`11c7f6db 488908          mov     qword ptr [rax],rcx									; rax->Flink = rcx
fffff800`11c7f6de 48895008        mov     qword ptr [rax+8],rdx									; rax->Blink = rdx
...
fffff800`11c7f6e8 48894108        mov     qword ptr [rcx+8],rax									; rcx->Blink = rax
fffff800`11c7f6ec 4889050d142e00  mov     qword ptr [nt!CcVacbFreeList (fffff800`11f60b00)],rax	; rdx->Flink = rax
