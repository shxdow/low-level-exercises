...
fffff803`d9f8b5f4 498b00          mov     rax,qword ptr [r8]													; rax->Flink = r8
fffff803`d9f8b5f7 4c89052a3cbeff  mov     qword ptr [nt!BurnMemoryDescriptor+0x8 (fffff803`d9b6f228)],r8		; ??->Blink = r8
fffff803`d9f8b5fe 4889051b3cbeff  mov     qword ptr [nt!BurnMemoryDescriptor (fffff803`d9b6f220)],rax			; ??->Flink = rax
...
fffff803`d9f8b612 48894808        mov     qword ptr [rax+8],rcx													; rax->Blink = ??
fffff803`d9f8b616 498908          mov     qword ptr [r8],rcx													; r8->Flink = ??
