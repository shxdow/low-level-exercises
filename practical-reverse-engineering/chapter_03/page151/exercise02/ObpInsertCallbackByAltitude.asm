...
fffff803`d9d790d7 488b4708        mov     rax,qword ptr [rdi+8]					; rax = rdi->Blink
fffff803`d9d790db 488b08          mov     rcx,qword ptr [rax]					; rcx = rax->Flink
fffff803`d9d790de 48894608        mov     qword ptr [rsi+8],rax					; rsi->Blink = rax
fffff803`d9d790e2 48890e          mov     qword ptr [rsi],rcx					; rsi->Flink = rcx
...
fffff803`d9d790ef 48897108        mov     qword ptr [rcx+8],rsi					; rcx->Blink = rsi
fffff803`d9d790f3 488930          mov     qword ptr [rax],rsi					; rax->Flink = rsi
