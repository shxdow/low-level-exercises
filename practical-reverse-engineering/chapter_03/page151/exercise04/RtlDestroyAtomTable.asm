...
fffff803`d9e94c6a 498b0e          mov     rcx,qword ptr [r14]					; rcx = r14->Flink 
fffff803`d9e94c6d 488b01          mov     rax,qword ptr [rcx]					; rax = rcx->Flink
...
fffff803`d9e94c7c 498906          mov     qword ptr [r14],rax					; r14->Flink = rax
fffff803`d9e94c7f 4c897008        mov     qword ptr [rax+8],r14					; rax->Blink = r14
