...
fffff803`d9987595 488b0f          mov     rcx,qword ptr [rdi]					; rcx = rdi->Flink
fffff803`d9987598 488b4708        mov     rax,qword ptr [rdi+8]					; rax = rdi->Blink
...
fffff803`d99875af 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`d99875b2 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
