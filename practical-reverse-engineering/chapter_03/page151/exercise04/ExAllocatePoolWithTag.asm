...
fffff803`d9af6457 498b4008        mov     rax,qword ptr [r8+8]					; rax = r8->Blink
...
fffff803`d9af6464 498b00          mov     rax,qword ptr [r8]					; rax = r8->Flink
...
fffff803`d9af6483 488903          mov     qword ptr [rbx],rax					; rbx->Flink = rax
fffff803`d9af6486 48895808        mov     qword ptr [rax+8],rbx					; rax->Blink = rbx
