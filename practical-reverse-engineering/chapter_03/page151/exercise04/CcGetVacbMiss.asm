...
fffff803`d9966fa8 488b10          mov     rdx,qword ptr [rax]					; rdx = rax->Flink
fffff803`d9966fab 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
...
fffff803`d9966fba 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`d9966fbd 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
