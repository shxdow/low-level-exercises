...
fffff803`d9e0e711 488b0e          mov     rcx,qword ptr [rsi]					; rcx = rsi->Flink
fffff803`d9e0e714 488b01          mov     rax,qword ptr [rcx]					; rax = rcx->Flink
...
fffff803`d9e0e72b 488906          mov     qword ptr [rsi],rax					; rsi->Flink = rax
fffff803`d9e0e72e 48897008        mov     qword ptr [rax+8],rsi					; rax->Blink = rsi
...
fffff803`d9e0e978 4d893424        mov     qword ptr [r12],r14					; r12->Flink = r14
fffff803`d9e0e97c 4d896608        mov     qword ptr [r14+8],r12					; r14->Blink = r12
...
nt!RtlZeroHeap+0x263:															; Two elements get remove / Two lists present
fffff803`d9e0ea2f 4d8906          mov     qword ptr [r14],r8					; 0.r14-Flink = r8
fffff803`d9e0ea32 49894608        mov     qword ptr [r14+8],rax					; 1.r14->Blink = rax
fffff803`d9e0ea36 4c8930          mov     qword ptr [rax],r14					; 1.rax->Flink = r14
fffff803`d9e0ea39 4d897008        mov     qword ptr [r8+8],r14					; 0.r8->Blink = r14
