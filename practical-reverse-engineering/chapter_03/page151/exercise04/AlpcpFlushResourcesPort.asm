...
fffff803`d9cecf2f 488b06          mov     rax,qword ptr [rsi]					; rax = rsi->Flink
...
fffff803`d9cecf46 498906          mov     qword ptr [r14],rax					; r14->Flink = rax
fffff803`d9cecf49 4c897008        mov     qword ptr [rax+8],r14					; rax->Blink = r14
