...
fffff800`11d605c4 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`11d605c8 488900          mov     qword ptr [rax],rax			; InitializeListHead
...
fffff800`12111034 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`12111038 488900          mov     qword ptr [rax],rax			; InitializeListHead
...
fffff800`121110f4 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`121110f8 488900          mov     qword ptr [rax],rax			; InitializeListHead
fffff800`121110fb 488d83f0000000  lea     rax,[rbx+0F0h]
fffff800`12111102 48894008        mov     qword ptr [rax+8],rax			; InitializeListHead
fffff800`12111106 488900          mov     qword ptr [rax],rax			; InitializeListHead
fffff800`12111109 488d4330        lea     rax,[rbx+30h]
fffff800`1211110d 48894008        mov     qword ptr [rax+8],ra			; InitializeListHeadx
fffff800`12111111 488900          mov     qword ptr [rax],rax			; InitializeListHead
