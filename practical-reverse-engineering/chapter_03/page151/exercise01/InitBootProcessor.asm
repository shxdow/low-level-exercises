...
fffff800`1236bcc2 488905cfddb8ff  mov     qword ptr [nt!WheapPfaList+0x8 (fffff800`11ef9a98)],rax		; InitializeListHead
fffff800`1236bcc9 488905c0ddb8ff  mov     qword ptr [nt!WheapPfaList (fffff800`11ef9a90)],rax			; InitializeListHead
...
fffff800`1236c220 48890511dab9ff  mov     qword ptr [nt!HandleTableListHead+0x8 (fffff800`11f09c38)],rax	; InitializeListHead
fffff800`1236c227 48890502dab9ff  mov     qword ptr [nt!HandleTableListHead (fffff800`11f09c30)],rax		; InitializeListHead
