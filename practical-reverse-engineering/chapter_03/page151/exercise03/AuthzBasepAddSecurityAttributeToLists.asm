...
fffff803`d9d5600f 4d8b4808        mov     r9,qword ptr [r8+8]					; r9 = r8->Blink
fffff803`d9d56013 4c8900          mov     qword ptr [rax],r8					; rax->Flink = r8
fffff803`d9d56016 4c894808        mov     qword ptr [rax+8],r9					; rax->Blink = r9
...
fffff803`d9d56026 498901          mov     qword ptr [r9],rax					; r9->Flink = rax
fffff803`d9d56029 49894008        mov     qword ptr [r8+8],rax					; r8->Blink = rax
