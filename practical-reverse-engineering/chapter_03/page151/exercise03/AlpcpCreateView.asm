...
fffff803`d9d1be4b 488b4208        mov     rax,qword ptr [rdx+8]					; rax = rdx->Blink
fffff803`d9d1be4f 498910          mov     qword ptr [r8],rdx					; r8->Flink = rdx
fffff803`d9d1be52 49894008        mov     qword ptr [r8+8],rax					; r8->Blink = rax
fffff803`d9d1be56 488b4208        mov     rax,qword ptr [rdx+8]					; rax = rdx->Blink
fffff803`d9d1be5a 4c8900          mov     qword ptr [rax],r8					; rax->Flink = r8
fffff803`d9d1be5d 4c894208        mov     qword ptr [rdx+8],r8					; rdx->Blink = r8
