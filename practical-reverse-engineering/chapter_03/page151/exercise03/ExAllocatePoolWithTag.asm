...
fffff803`d9af6597 488b4108        mov     rax,qword ptr [rcx+8]					; rax = rcx->Blink
fffff803`d9af659b 48890a          mov     qword ptr [rdx],rcx					; rdx->Flink = rcx
fffff803`d9af659e 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`d9af65ab 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`d9af65ae 48895108        mov     qword ptr [rcx+8],rdx					; rcx->Blink = rdx
...
fffff803`d9af6980 488b4108        mov     rax,qword ptr [rcx+8]					; rax = rcx->Blink
fffff803`d9af6984 48890e          mov     qword ptr [rsi],rcx					; rsi->Flink = rcx
fffff803`d9af6987 48894608        mov     qword ptr [rsi+8],rax					; rsi->Blink = rax
...
fffff803`d9af699c 488930          mov     qword ptr [rax],rsi					; rax->Flink = rsi
fffff803`d9af699f 48897108        mov     qword ptr [rcx+8],rsi					; rcx->Blink = rsi
