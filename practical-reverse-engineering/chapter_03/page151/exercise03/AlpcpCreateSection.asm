...
fffff803`d9d14080 498b4708        mov     rax,qword ptr [r15+8]									; rax = r15->Blink
fffff803`d9d14084 4c893e          mov     qword ptr [rsi],r15									; rsi->Flink = r15
fffff803`d9d14087 48894608        mov     qword ptr [rsi+8],rax									; rsi->Blink = rax
...
fffff803`d9d14094 488930          mov     qword ptr [rax],rsi									; rax->Flink = rsi
fffff803`d9d14097 49897708        mov     qword ptr [r15+8],rsi									; r15->Blink = rsi
