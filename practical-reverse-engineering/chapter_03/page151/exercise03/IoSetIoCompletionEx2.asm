...
fffff803`d98b1f74 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
fffff803`d98b1f78 488907          mov     qword ptr [rdi],rax					; rdi->Flink = rax
fffff803`d98b1f7b 48894f08        mov     qword ptr [rdi+8],rcx					; rdi->Blink = rcx
...
fffff803`d98b1f88 488939          mov     qword ptr [rcx],rdi					; rcx->Flink = rdi
fffff803`d98b1f8b 48897808        mov     qword ptr [rax+8],rdi					; rax->Blink = rdi
...
fffff803`d98b22e4 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
fffff803`d98b22e8 488907          mov     qword ptr [rdi],rax					; rdi->Flink = rax
fffff803`d98b22eb 48894f08        mov     qword ptr [rdi+8],rcx					; rdi->Blink = rcx
...
fffff803`d98b22f8 488939          mov     qword ptr [rcx],rdi					; rcx->Flink = rdi
fffff803`d98b22fb 48897808        mov     qword ptr [rax+8],rdi					; rax->Blink = rdi
...
fffff803`d9a59c0c 488b08          mov     rcx,qword ptr [rax]					; rcx = rax->Flink
fffff803`d9a59c0f 48894708        mov     qword ptr [rdi+8],rax					; rdi->Blink = rax
fffff803`d9a59c13 48890f          mov     qword ptr [rdi],rcx					; rdi->Flink = rcx
...
fffff803`d9a59c23 48897908        mov     qword ptr [rcx+8],rdi					; rcx->Blink = rdi
fffff803`d9a59c27 488938          mov     qword ptr [rax],rdi					; rax->Flink = rdi
...
fffff803`d9a59dd1 488b10          mov     rdx,qword ptr [rax]					; rdx = rax->Flink
fffff803`d9a59dd4 48894708        mov     qword ptr [rdi+8],rax					; rdi->Blink = rax
fffff803`d9a59dd8 488917          mov     qword ptr [rdi],rdx					; rdi->Flink = rdx
...
fffff803`d9a59de8 48897a08        mov     qword ptr [rdx+8],rdi					; rdx->Blink = rdi
fffff803`d9a59dec 488938          mov     qword ptr [rax],rdi					; rax->Flink = rdi
