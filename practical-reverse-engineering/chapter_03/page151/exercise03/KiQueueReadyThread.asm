...
fffff803`d9909bb0 488b01          mov     rax,qword ptr [rcx]					; rax = rcx->Flink
fffff803`d9909bb3 48894b08        mov     qword ptr [rbx+8],rcx					; rbx->Blink = rcx
fffff803`d9909bb7 488903          mov     qword ptr [rbx],rax					; rbx->Flink = rax
...
fffff803`d9909bc4 48895808        mov     qword ptr [rax+8],rbx					; rax->Blink = rbx
fffff803`d9909bc8 488919          mov     qword ptr [rcx],rbx					; rcx->Flink = rbx
...
fffff803`d9909bf4 488b4108        mov     rax,qword ptr [rcx+8]					; rax = rcx->Blink
fffff803`d9909bf8 48890b          mov     qword ptr [rbx],rcx					; rbx->Flink = rcx
fffff803`d9909bfb 48894308        mov     qword ptr [rbx+8],rax					; rbx->Blink = rax
...
fffff803`d9909c08 488918          mov     qword ptr [rax],rbx					; rax->Flink = rbx
fffff803`d9909c0b 48895908        mov     qword ptr [rcx+8],rbx					; rcx->Blink = rbx
