...
fffff803`d9980d89 488911          mov     qword ptr [rcx],rdx											; rcx->Flink = rdx
fffff803`d9980d8c 48894a08        mov     qword ptr [rdx+8],rcx											; rdx->Blink = rcx
...
fffff803`d9980d9e 48894808        mov     qword ptr [rax+8],rcx											; rax->Blink = rvc
fffff803`d9980da2 488910          mov     qword ptr [rax],rdx											; rax->Flink = rdx
...
fffff803`d9980dae 488901          mov     qword ptr [rcx],rax											; rcx->Flink = rax
...
fffff803`d9980ee9 488911          mov     qword ptr [rcx],rdx							; rcx->Flink = rdx
fffff803`d9980eec 48894a08        mov     qword ptr [rdx+8],rcx							; rdx->Blink = rcx
...
fffff803`d9980efe 48894808        mov     qword ptr [rax+8],rcx							; rax->Blink = rcx
fffff803`d9980f02 488910          mov     qword ptr [rax],rdx							; rax->Flink = rdx
...
fffff803`d9980f0e 488901          mov     qword ptr [rcx],rax							; rcx->Flink = rax
fffff803`d9980f11 48890590dc1e00  mov     qword ptr [nt!CcDirtySharedCacheMapWithLogHandleList+0x8 (fffff803`d9b6eba8)],rax		; ??->Blink = rax
...
fffff803`d9a54345 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`d9a54348 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`d9a5435a 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
fffff803`d9a5435e 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
...
fffff803`d9a5436d 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9a54370 48890531a81100  mov     qword ptr [nt!CcDirtySharedCacheMapWithLogHandleList+0x8 (fffff803`d9b6eba8)],rax		; ??->Blink = rax

nt! ?? ::FNODOBFM::`string'+0x4790:
fffff803`d9a54377 488d8788000000  lea     rax,[rdi+88h]
fffff803`d9a5437e 488b10          mov     rdx,qword ptr [rax]					; rdx = rax->Flink
fffff803`d9a54381 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
...
fffff803`d9a54390 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`d9a54393 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`d9a543a5 48894808        mov     qword ptr [rax+8],rcx					; rcx->Blink = rcx
fffff803`d9a543a9 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
...
fffff803`d9a543b8 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9a543bb 48890526a81100  mov     qword ptr [nt!CcLazyWriterCursor+0x8 (fffff803`d9b6ebe8)],rax			; ??->Blink = rax
