...
fffff803`d9db9c7f 488b5008        mov     rdx,qword ptr [rax+8]					; rdx = rax->Blink
fffff803`d9db9c83 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9db9c86 48895108        mov     qword ptr [rcx+8],rdx					; rcx->Blink = rdx
...
fffff803`d9db9c96 48890a          mov     qword ptr [rdx],rcx					; rdx->Flink = rcx
fffff803`d9db9c99 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d9db9cf2 4989442408      mov     qword ptr [r12+8],rax					; r12->Blink = rax
fffff803`d9db9cf7 49891c24        mov     qword ptr [r12],rbx					; r12->Flink = rbx
...
fffff803`d9db9d07 4c8920          mov     qword ptr [rax],r12					; rax->Flink = r12
fffff803`d9db9d0a 4533ed          xor     r13d,r13d
fffff803`d9db9d0d 33c0            xor     eax,eax
fffff803`d9db9d0f 4c896308        mov     qword ptr [rbx+8],r12					; rbx->Blink = r12
...
fffff803`d9db9d7f 4c8930          mov     qword ptr [rax],r14					; rax->Flink = r14
fffff803`d9db9d82 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d9db9d92 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9db9d95 488bcf          mov     rcx,rdi
fffff803`d9db9d98 49894608        mov     qword ptr [r14+8],rax					; r14->Blink = rax
...
fffff803`d9db9ddc 488b4308        mov     rax,qword ptr [rbx+8]					; rax = rbx->Blink
fffff803`d9db9de0 49891f          mov     qword ptr [r15],rbx					; r15->Flink = rbx
fffff803`d9db9de3 49894708        mov     qword ptr [r15+8],rax					; r15->Blink = rax
...
fffff803`d9db9df3 4c8938          mov     qword ptr [rax],r15					; rax->Flink = r15
fffff803`d9db9df6 4c897b08        mov     qword ptr [rbx+8],r15					; rbx->Blink = r15
...
fffff803`d9dba399 488b5008        mov     rdx,qword ptr [rax+8]					; rdx = rax->Blink
fffff803`d9dba39d 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9dba3a0 48895108        mov     qword ptr [rcx+8],rdx					; rcx->Blink = rdx
...
fffff803`d9dba3b0 48890a          mov     qword ptr [rdx],rcx					; rdx->Flink = rcx
fffff803`d9dba3b3 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d9dba3f7 48891d8a32dbff  mov     qword ptr [nt!CmpTransactionListLock+0x8 (fffff803`d9b6d688)],rbx ; ??->Blink = rbx
fffff803`d9dba3fe 488b4818        mov     rcx,qword ptr [rax+18h]
fffff803`d9dba402 4883c010        add     rax,10h
fffff803`d9dba406 49894e08        mov     qword ptr [r14+8],rcx												; r14->Blink = rcx
fffff803`d9dba40a 498906          mov     qword ptr [r14],rax												; r14->Flink = rax
...
fffff803`d9dba419 4c8931          mov     qword ptr [rcx],r14												; rcx->Flink = r14
fffff803`d9dba41c 4c897008        mov     qword ptr [rax+8],r14												; rax->Blink = r14
