...
fffff803`22187959 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`2218795c 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`22241944 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`22241947 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`22241acc 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`22241acf 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`22241ae5 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`22241ae8 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
