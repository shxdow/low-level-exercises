...
fffff803`21ee3b25 4c8902          mov     qword ptr [rdx],r8					; rdx->Flink = r8
fffff803`21ee3b28 49895008        mov     qword ptr [r8+8],rdx					; r8->Blink = rdx
...
fffff803`21ee40ab 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`21ee40ae 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
nt!ExFreePool+0xc3a:
fffff803`21ee4cf0 4c8902          mov     qword ptr [rdx],r8					; rdx->Flink = r8
fffff803`21ee4cf3 49895008        mov     qword ptr [r8+8],rdx					; r8->Blink = rdx
...
fffff803`221e97a1 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`221e97a4 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
