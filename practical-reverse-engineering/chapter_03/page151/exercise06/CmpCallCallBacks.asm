...
fffff803`2214d68f 0f85c3030000    jne     nt!CmpCallCallBacks+0x418 (fffff803`2214da58)
	...
	fffff803`2214d974 48894608        mov     qword ptr [rsi+8],rax				; rsi->Blink = rax
	fffff803`2214d978 488930          mov     qword ptr [rax],rsi				; rax->Flink = rsi
	...
	fffff803`22241d9b 488908          mov     qword ptr [rax],rcx				; rax->Flink = rcx
	fffff803`22241d9e 48894108        mov     qword ptr [rcx+8],rax				; rcx->Blink = rax
