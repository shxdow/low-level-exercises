...
fffff803`221be4de 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`221be4e1 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`221be552 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`221be555 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
