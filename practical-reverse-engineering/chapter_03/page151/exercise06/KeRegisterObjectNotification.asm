...
fffff803`21d2a105 4d8906          mov     qword ptr [r14],r8					; r14->Flink = r8
fffff803`21d2a108 4d897008        mov     qword ptr [r8+8],r14					; r8->Blink = r14
...
fffff803`21d78b63 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`21d78b66 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
