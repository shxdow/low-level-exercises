...
fffff803`d9eec080 48895008        mov     qword ptr [rax+8],rdx					; rax->Blink = rdx
fffff803`d9eec084 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
...
fffff803`d9ef26c6 48895108        mov     qword ptr [rcx+8],rdx					; rcx->Blink = rdx
fffff803`d9ef26ca 48890a          mov     qword ptr [rdx],rcx					; rdx->Flink = rcx
