...
fffff803`d9c2f78f 48891512e1f3ff  mov     qword ptr [nt!CmpDelayedLRUListHead+0x8 (fffff803`d9b6d8a8)],rdx	; r8->Blink = rdx
fffff803`d9c2f796 4c8902          mov     qword ptr [rdx],r8												; rdx->Flink = r8
