...
fffff803`d9919985 48894f08        mov     qword ptr [rdi+8],rcx					; rdi->Blink = rcx
fffff803`d9919989 488907          mov     qword ptr [rdi],rax					; rdi->Flink = rax
...
fffff803`d9919995 488939          mov     qword ptr [rcx],rdi					; rcx->Flink = rdi
fffff803`d9919998 48897808        mov     qword ptr [rax+8],rdi					; rax->Blink = rdi
