...
fffff803`d9d056d3 488910          mov     qword ptr [rax],rdx												; rax->Flink = rdx
fffff803`d9d056d6 48894808        mov     qword ptr [rax+8],rcx												; rax->Blink = rcx
...
fffff803`d9d056e3 488901          mov     qword ptr [rcx],rax												; rcx->Flink = rax
fffff803`d9d056e6 4889059b95e1ff  mov     qword ptr [nt!PsActiveProcessHead+0x8 (fffff803`d9b1ec88)],rax	; rdx->Blink = rax
