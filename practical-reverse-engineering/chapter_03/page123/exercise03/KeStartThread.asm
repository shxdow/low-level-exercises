...
fffff803`d9969622 488910          mov     qword ptr [rax],rdx												; rax->Flink = rdx
fffff803`d9969625 48894808        mov     qword ptr [rax+8],rcx												; rax->Blink = rcx
...
fffff803`d9969632 488901          mov     qword ptr [rcx],rax												; rcx->Flink = rax
fffff803`d9969635 44853d484a2700  test    dword ptr [nt!PerfGlobalGroupMask+0x4 (fffff803`d9bde084)],r15d
fffff803`d996963c 48890585061f00  mov     qword ptr [nt!KiProcessListHead+0x8 (fffff803`d9b59cc8)],rax		; rdx->Blink = rax
...
fffff803`d99696cf 488930          mov     qword ptr [rax],rsi					; rax->Flink = rsi
fffff803`d99696d2 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d99696df 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d99696e2 48894608        mov     qword ptr [rsi+8],rax					; rsi->Blink = rax
