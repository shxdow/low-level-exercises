...
fffff803`d99b0d30 488b4208        mov     rax,qword ptr [rdx+8]					; rax = rdx->Blink
fffff803`d99b0d34 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`d99b0d37 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`d99b0d44 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`d99b0d47 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`d99b0dc0 488b01          mov     rax,qword ptr [rcx]					; rax = rcx->Flink
fffff803`d99b0dc3 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
fffff803`d99b0dc7 488902          mov     qword ptr [rdx],rax					; rdx->Flink = rax
...
fffff803`d99b0dd0 48895008        mov     qword ptr [rax+8],rdx					; rax->Blink = rdx
fffff803`d99b0dd4 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
