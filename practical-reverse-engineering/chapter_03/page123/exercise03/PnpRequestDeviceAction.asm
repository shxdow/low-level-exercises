...
fffff803`d98be323 48894608        mov     qword ptr [rsi+8],rax													; rsi->Blink = rax
fffff803`d98be327 48890e          mov     qword ptr [rsi],rcx													; rsi->Flink = rcx
...
fffff803`d98be333 488930          mov     qword ptr [rax],rsi													; rax->Flink = rsi
fffff803`d98be336 4889350bd42900  mov     qword ptr [nt!PnpEnumerationRequestList+0x8 (fffff803`d9b5b748)],rsi	; rcx->Blink = rsi
