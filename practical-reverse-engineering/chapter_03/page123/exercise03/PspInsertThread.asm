...
fffff803`d9cf852d 488b5008        mov     rdx,qword ptr [rax+8]					; rdx = rax->Blink
fffff803`d9cf8531 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d9cf8534 48895108        mov     qword ptr [rcx+8],rdx					; rcx->Blink = rdx
...
fffff803`d9cf8541 48890a          mov     qword ptr [rdx],rcx					; rdx->Flink = rcx
fffff803`d9cf8544 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
