...
fffff803`d996feea 488910          mov     qword ptr [rax],rdx										; rax->Flink = rdx
fffff803`d996feed 48894808        mov     qword ptr [rax+8],rcx										; rax->Blink = rcx
...
fffff803`d996fefa 488901          mov     qword ptr [rcx],rax										; rcx->Flink = rax
fffff803`d996fefd 48890554331e00  mov     qword ptr [nt!MmProcessList+0x8 (fffff803`d9b53258)],rax	; rdx->Blink = rax
...
fffff803`d996ff14 488b5108        mov     rdx,qword ptr [rcx+8]										; rdx = rcx->Blink
fffff803`d996ff18 488908          mov     qword ptr [rax],rcx										; rax->Flink = rcx
fffff803`d996ff1b 48895008        mov     qword ptr [rax+8],rdx										; rax->Blink = rdx
...
fffff803`d996ff28 488902          mov     qword ptr [rdx],rax										; rdx->Flink = rax
fffff803`d996ff2b 48894108        mov     qword ptr [rcx+8],rax										; rcx->Blink = rax
