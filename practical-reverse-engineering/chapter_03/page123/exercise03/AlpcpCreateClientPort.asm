...
fffff803`d9d147fb 48895108        mov     qword ptr [rcx+8],rdx									; rcx->Blink = rdx
fffff803`d9d147ff 488901          mov     qword ptr [rcx],rax									; rcx->Flink = rax
...
fffff803`d9d1480b 48890a          mov     qword ptr [rdx],rcx									; rdx->Flink = rcx
fffff803`d9d1480e 48894808        mov     qword ptr [rax+8],rcx									; rax->Blink = rcx
