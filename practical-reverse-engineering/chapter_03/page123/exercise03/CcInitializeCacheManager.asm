...
fffff803`d9f77ccd 48894808        mov     qword ptr [rax+8],rcx													; rax->Blink = rcx
fffff803`d9f77cd1 488910          mov     qword ptr [rax],rdx													; rax->Flink = rdx
...
fffff803`d9f77ce0 488901          mov     qword ptr [rcx],rax													; rcx->Flink = rax
fffff803`d9f77ce3 4889058e6fbfff  mov     qword ptr [nt!CcIdleWorkerThreadList+0x8 (fffff803`d9b6ec78)],rax		; rdx->Blink = rax
...
fffff803`d9f77d41 48894808        mov     qword ptr [rax+8],rcx															; rax->Blink = rcx
fffff803`d9f77d45 488910          mov     qword ptr [rax],rdx															; rax->Flink = rdx
...
fffff803`d9f77d5b 488901          mov     qword ptr [rcx],rax															; rcx->Flink = rax
fffff803`d9f77d5e 4889052371bfff  mov     qword ptr [nt!CcIdleExtraWriteBehindThreadList+0x8 (fffff803`d9b6ee88)],rax	; rdx->Blink = rax
