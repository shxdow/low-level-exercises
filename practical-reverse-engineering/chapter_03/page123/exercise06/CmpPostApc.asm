...
nt!CmpPostApc+0x12e:
fffff803`2206ed66 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`2206ed69 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
nt!CmpPostApc+0x16e:
fffff803`2206eda6 4c8902          mov     qword ptr [rdx],r8					; rdx->Flink = r8
fffff803`2206eda9 49895008        mov     qword ptr [r8+8],rdx					; r8->Blink = rdx
...
nt!CmpPostApc+0x18b:
fffff803`2206edc3 4c8900          mov     qword ptr [rax],r8					; rax->Flink = r8
fffff803`2206edc6 49894008        mov     qword ptr [r8+8],rax					; r8->Blink = rax
