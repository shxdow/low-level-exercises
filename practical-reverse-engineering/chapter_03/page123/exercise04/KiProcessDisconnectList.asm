...
fffff803`d9a05621 488b03          mov     rax,qword ptr [rbx]					; rax = rbx->Flink
...
fffff803`d9a05629 488b08          mov     rcx,qword ptr [rax]					; rcx = rax->Flink
...
fffff803`d9a05638 48890b          mov     qword ptr [rbx],rcx					; rbx->Flink = rcx
fffff803`d9a0563b 48895908        mov     qword ptr [rcx+8],rbx					; rcx->Blink = rbx
