...
fffff803`d9dbd081 4c8d3d5806dbff  lea     r15,[nt!CmpLazyCommitListHead (fffff803`d9b6d6e0)]				; r15 = ..
...
fffff803`d9dbd0b8 488b1d2106dbff  mov     rbx,qword ptr [nt!CmpLazyCommitListHead (fffff803`d9b6d6e0)]		; rbx = ..
fffff803`d9dbd0bf 488b03          mov     rax,qword ptr [rbx]												; rax = ..
...
fffff803`d9dbd0d6 4889050306dbff  mov     qword ptr [nt!CmpLazyCommitListHead (fffff803`d9b6d6e0)],rax		; r15->Flink = rax
fffff803`d9dbd0dd 4c897808        mov     qword ptr [rax+8],r15												; rax->Blink = r15
