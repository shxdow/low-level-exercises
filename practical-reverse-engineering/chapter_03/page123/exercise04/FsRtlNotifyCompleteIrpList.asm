...
fffff803`d9c60a3a 488b10          mov     rdx,qword ptr [rax]					; rdx = rax->Flink
fffff803`d9c60a3d 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
...
fffff803`d9c60a4c 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`d9c60a4f 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
