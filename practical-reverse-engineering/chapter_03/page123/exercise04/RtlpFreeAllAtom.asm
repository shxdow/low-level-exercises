...
fffff803`d98be7fb 488b0b          mov     rcx,qword ptr [rbx]					; rcx = rbx->Flink
fffff803`d98be7fe 488b01          mov     rax,qword ptr [rcx]					; rax = rcx->Flink
...
fffff803`d98be80d 488903          mov     qword ptr [rbx],rax					; rbx->Flink = rax
fffff803`d98be810 48895808        mov     qword ptr [rax+8],rbx					; rax->Blink = rbx
