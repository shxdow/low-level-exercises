...
fffff803`d989f0d0 488d0de1f42b00  lea     rcx,[nt!PnpDeviceCompletionQueue+0x18 (fffff803`d9b5e5b8)]			; rcx = ??
...
fffff803`d989f0e6 488905cbf42b00  mov     qword ptr [nt!PnpDeviceCompletionQueue+0x18 (fffff803`d9b5e5b8)],rax	; rcx->Flink = rax
fffff803`d989f0ed 48894808        mov     qword ptr [rax+8],rcx													; rax->Blink = rcx
