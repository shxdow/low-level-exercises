...
fffff800`11fdcd6f 48891502d9feff  mov     qword ptr [nt!KiInitialProcess+0x478 (fffff800`11fca678)],rdx ; InitializeListHead
fffff800`11fdcd76 488915f3d8feff  mov     qword ptr [nt!KiInitialProcess+0x470 (fffff800`11fca670)],rdx	; InitializeListHead
