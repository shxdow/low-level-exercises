...
fffff803`d9be54ac 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`d9be54af 48895808        mov     qword ptr [rax+8],rbx					; rax->Blink = rbx
...
fffff803`d9be54bd 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
fffff803`d9be54c1 488903          mov     qword ptr [rbx],rax					; rbx->Flink = rax
