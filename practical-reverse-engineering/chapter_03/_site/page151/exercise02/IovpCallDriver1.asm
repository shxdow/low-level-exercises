...
fffff803`d9ed1ce1 4c8902          mov     qword ptr [rdx],r8							; rdx->Flink = r8
fffff803`d9ed1ce4 48894208        mov     qword ptr [rdx+8],rax							; rdx->Blink = rax
...
fffff803`d9ed1cf5 49895008        mov     qword ptr [r8+8],rdx							; r8->Blink = rdx
fffff803`d9ed1cf9 488910          mov     qword ptr [rax],rdx							; rax->Flink = rdx
