...
fffff803`21d05831 4c8906          mov     qword ptr [rsi],r8					; rsi->Flink = r8
fffff803`21d05834 49897008        mov     qword ptr [r8+8],rsi					; r8->Blink = rsi
...
fffff803`21e71a93 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`21e71a96 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
