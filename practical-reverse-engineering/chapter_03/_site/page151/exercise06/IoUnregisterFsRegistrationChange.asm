...
fffff803`21c84162 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`21c84165 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`21c8437b 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`21c8437e 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`21c84681 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`21c84684 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`21c847fb 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`21c847fe 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`21cfde69 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`21cfde6c 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`21cfe363 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`21cfe366 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`21cfe656 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`21cfe659 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
