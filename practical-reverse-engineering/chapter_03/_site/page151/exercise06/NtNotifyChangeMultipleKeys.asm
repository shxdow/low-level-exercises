...
fffff803`220736c9 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
fffff803`220736cc 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
...
fffff803`220736f3 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`220736f6 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`2207386d 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`22073870 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`22073891 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`22073894 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`220738b6 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`220738b9 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`2207398b 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`2207398e 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`220739af 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`220739b2 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
...
fffff803`220739d4 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`220739d7 48894808        mov     qword ptr [rax+8],rcx					; rax->Blik = rcx
...
fffff803`220739f8 488911          mov     qword ptr [rcx],rdx					; rcx->Flink = rdx
fffff803`220739fb 48894a08        mov     qword ptr [rdx+8],rcx					; rdx->Blink = rcx
