...
fffff803`d9a52f0f 488911          mov     qword ptr [rcx],rdx																; rcx->Flink = rdx
fffff803`d9a52f12 48894a08        mov     qword ptr [rdx+8],rcx																; rdx->Blink = rcx
fffff803`d9a52f16 488b0d8bbc1100  mov     rcx,qword ptr [nt!CcDirtySharedCacheMapWithLogHandleList+0x8 (fffff803`d9b6eba8)]	; rcx = ??->Blink
fffff803`d9a52f1d 488d157cbc1100  lea     rdx,[nt!CcDirtySharedCacheMapWithLogHandleList (fffff803`d9b6eba0)]
fffff803`d9a52f24 48894808        mov     qword ptr [rax+8],rcx																; rax->Blink = rcx
fffff803`d9a52f28 488910          mov     qword ptr [rax],rdx																; rax->Flink = rdx
...
fffff803`d9a52f37 488901          mov     qword ptr [rcx],rax																; rcx->Flink = rax
fffff803`d9a52f3a 48890567bc1100  mov     qword ptr [nt!CcDirtySharedCacheMapWithLogHandleList+0x8 (fffff803`d9b6eba8)],rax ; rdx->Blink = rax
