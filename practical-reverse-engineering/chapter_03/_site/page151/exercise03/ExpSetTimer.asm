...
fffff803`d990e3af 4c8b4208        mov     r8,qword ptr [rdx+8]					; r8 = rdx->Blink
fffff803`d990e3b3 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`d990e3b6 4c894008        mov     qword ptr [rax+8],r8					; rax->Blink = r8
...
fffff803`d990e3c3 498900          mov     qword ptr [r8],rax					; r8->Flink = rax
fffff803`d990e3c6 48894208        mov     qword ptr [rdx+8],rax					; rdx->Blink = rax
...
fffff803`d990e585 488910          mov     qword ptr [rax],rdx					; rax->Flink = rdx
fffff803`d990e588 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d990e591 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d990e594 488905dd8c2000  mov     qword ptr [nt!ExpWakeTimerList+0x8 (fffff803`d9b17278)],rax	; rdx->Blink = rax
