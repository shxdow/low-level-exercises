...
fffff803`d9893287 488b0d7ab82d00  mov     rcx,qword ptr [nt!CcVacbFreeList+0x8 (fffff803`d9b6eb08)]		; rcx = ??
fffff803`d989328e 4c8900          mov     qword ptr [rax],r8											; rax->Flink = r8
fffff803`d9893291 48894808        mov     qword ptr [rax+8],rcx											; rax->Blink = rcx
...
fffff803`d989329a 488901          mov     qword ptr [rcx],rax											; rcx->Flink = rax
fffff803`d989329d ff0535b82d00    inc     dword ptr [nt!CcNumberOfFreeVacbs (fffff803`d9b6ead8)]
fffff803`d98932a3 4889055eb82d00  mov     qword ptr [nt!CcVacbFreeList+0x8 (fffff803`d9b6eb08)],rax		; rcx->Blink = rax
...
fffff803`d98932c4 4c8908          mov     qword ptr [rax],r9											; rax->Flink = r9
fffff803`d98932c7 48894808        mov     qword ptr [rax+8],rcx											; rax->Blink = rcx
...
fffff803`d98932d0 488901          mov     qword ptr [rcx],rax													; rcx->Flink = rax
fffff803`d98932d3 ff0503b82d00    inc     dword ptr [nt!CcNumberOfFreeHighPriorityVacbs (fffff803`d9b6eadc)]
fffff803`d98932d9 48890538b82d00  mov     qword ptr [nt!CcVacbFreeHighPriorityList+0x8 (fffff803`d9b6eb18)],rax	; rcx->Blink = rax
