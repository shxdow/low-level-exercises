...
fffff803`d99d4642 488b4808        mov     rcx,qword ptr [rax+8]					; rcx = rax->Blink
fffff803`d99d4646 488903          mov     qword ptr [rbx],rax					; rbx->Flink = rax
fffff803`d99d4649 48894b08        mov     qword ptr [rbx+8],rcx					; rbx->Blink = rcx
...
fffff803`d99d4652 488919          mov     qword ptr [rcx],rbx					; rcx->Flink = rbx
fffff803`d99d4655 48895808        mov     qword ptr [rax+8],rbx					; rax->Blink = rbx
