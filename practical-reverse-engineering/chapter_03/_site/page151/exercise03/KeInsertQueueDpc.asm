...
fffff803`d992fd63 488b4f08        mov     rcx,qword ptr [rdi+8]					; rcx = rdi->Blink
fffff803`d992fd67 488938          mov     qword ptr [rax],rdi					; rax->Flink = rdi
fffff803`d992fd6a 48894808        mov     qword ptr [rax+8],rcx					; rax->Blink = rcx
...
fffff803`d992fd77 488901          mov     qword ptr [rcx],rax					; rcx->Flink = rax
fffff803`d992fd7a 48894708        mov     qword ptr [rdi+8],rax					; rdi->Blink = rax
...
fffff803`d992fec1 488b0f          mov     rcx,qword ptr [rdi]					; rcx = rdi->Flink
fffff803`d992fec4 48897808        mov     qword ptr [rax+8],rdi					; rax->Blink = rdi
fffff803`d992fec8 488908          mov     qword ptr [rax],rcx					; rax->Flink = rcx
...
fffff803`d992fed5 48894108        mov     qword ptr [rcx+8],rax					; rcx->Blink = rax
fffff803`d992fed9 488907          mov     qword ptr [rdi],rax					; rdi->Flink = rax
